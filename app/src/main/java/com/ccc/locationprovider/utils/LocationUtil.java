...
public class LocationUtil {
    ...
    public static double[] getCurrentLocation(Context context, LocationCallBack locationCallBack) {
        ...
        MyLocationListener locationListener = new MyLocationListener(locationM, locationCallBack,lat);
        //配置Criteria耗电低
    ...
    private static class MyLocationListener implements LocationListener {
        ...
        public MyLocationListener(LocationManager locationManager, LocationCallBack locationCallBack,double[] temp) {
            this.mLocationManager = locationManager;
            this.mLocationCallBack = locationCallBack;
            this.lat = temp;
        }
